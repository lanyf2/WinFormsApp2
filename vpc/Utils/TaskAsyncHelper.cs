...
namespace vpc
{
    internal static class TaskAsyncHelper
    {
        ...
        internal static async void RunAsync(Action function, Action callback)
        {
        ...
        internal static async void RunAsync<TResult>(Func<TResult> function, Action<TResult> callback)
        {
