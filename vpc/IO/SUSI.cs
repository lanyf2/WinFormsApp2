...
namespace SUSI
{
    ...
    static public class SUSI_DLL
    {
        ...
        [DllImport("SUSI")]
        public static extern void SusiDllGetVersion(UInt32[] major,UInt32[] minor);
    ...
    static public class SUSI_Core
    {
        ...
        [DllImport("SUSI")]
        public static extern bool SusiCoreAccessBootCounter(UInt32 mode, UInt32 OPFlag,ref bool enable,ref UInt32 value);
        ...
        [DllImport("SUSI")]
        public static extern int SusiCoreGetBIOSVersion(StringBuilder BIOSVersion,ref UInt32 size);
        //public unsafe static extern int SusiCoreGetBIOSVersion(char* BIOSVersion, UInt32* size);
        [DllImport("SUSI")]
        public static extern int SusiCoreGetPlatformName(StringBuilder PlatformName, ref UInt32 size);
        //public unsafe static extern int SusiCoreGetPlatformName(char* PlatformName, UInt32* size);

        // Old (backward-compatible)
        [DllImport("SUSI")]
        public static extern int SusiGetPlatformName(StringBuilder PlatformName, byte size);
        //public unsafe static extern int SusiGetPlatformName(char* PlatformName, byte size);
        [DllImport("SUSI")]
        public static extern int SusiGetBIOSVersion(StringBuilder BIOSVersion, byte size);
        ...
        [DllImport("SUSI")]
        public static extern bool SusiCoreReadULongIO(UInt32 addr,ref UInt32 value);
    ...
    static public class SUSI_HWM
    {
        ...
        [DllImport("SUSI")]
        public static extern bool SusiHWMGetFanSpeed(UInt16 fanType,ref UInt16 retval,ref UInt16 typeSupport);
        //public unsafe static extern bool SusiHWMGetFanSpeed(UInt16 fanType, UInt16* retval, UInt16* typeSupport);
        [DllImport("SUSI")]
        public static extern bool SusiHWMGetTemperature(UInt16 tempType,ref float retval,ref UInt16 typeSupport);
        //public unsafe static extern bool SusiHWMGetTemperature(UInt16 tempType, float* retval, UInt16* typeSupport);
        [DllImport("SUSI")]
        public static extern bool SusiHWMGetVoltage(UInt32 voltType,ref float retval,ref UInt32 typeSupport);
        //public unsafe static extern bool SusiHWMGetVoltage(UInt32 voltType, float* retval, UInt32* typeSupport);
        [DllImport("SUSI")]
        public static extern bool SusiHWMSetFanSpeed(UInt16 fanType, byte setval,ref UInt16 typeSupport);
    ...
    static public class SUSI_GPIO
    {
        ...
        // Programmable
        [DllImport("SUSI")]
        public static extern bool SusiIOCountEx(ref UInt32 inCount,ref UInt32 outCount);
        //public unsafe static extern bool SusiIOCountEx(UInt32* inCount, UInt32* outCount);
        [DllImport("SUSI")]
        public static extern bool SusiIOQueryMask(UInt32 flag,ref UInt32 Mask);
        //public unsafe static extern bool SusiIOQueryMask(UInt32 flag, UInt32* Mask);
        [DllImport("SUSI")]
        public static extern bool SusiIOReadEx(byte PinNum,ref UInt32 status);
        //public unsafe static extern bool SusiIOReadEx(byte PinNum, UInt32* status);
        [DllImport("SUSI")]
        public static extern bool SusiIOReadMultiEx(UInt32 TargetPinMask,ref UInt32 StatusMask);
        //public unsafe static extern bool SusiIOReadMultiEx(UInt32 TargetPinMask, UInt32* StatusMask);
        [DllImport("SUSI")]
        public static extern bool SusiIOSetDirection(byte PinNum, byte IO,ref UInt32 PinDirMask);
        //public unsafe static extern bool SusiIOSetDirection(byte PinNum, byte IO, UInt32* PinDirMask);
        [DllImport("SUSI")]
        public static extern bool SusiIOSetDirectionMulti(UInt32 TargetPinMask,ref UInt32 PinDirMask);
        //public unsafe static extern bool SusiIOSetDirectionMulti(UInt32 TargetPinMask, UInt32* PinDirMask);
        [DllImport("SUSI")]
        public static extern bool SusiIOWriteEx(byte PinNum, Int32 status);
        //public unsafe static extern bool SusiIOWriteEx(byte PinNum, Int32 status);
        [DllImport("SUSI")]
        public static extern bool SusiIOWriteMultiEx(UInt32 TargetPinMask, UInt32 StatusMask);
